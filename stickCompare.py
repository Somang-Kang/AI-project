...
img2=cv2.imread('/Users/somang/Desktop/ex15.png')
img2copy=img2.copy()
...
cv2.drawContours(img2,contours,-1,(255,255,0),2)
...
img = cv2.imread('blob_detection/' + folder + '/croped' + number + '.jpg')
'''
...
picname = "blob_detection/" + folder + "/croped_checkedImg_" + number + ".jpg"
